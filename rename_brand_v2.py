...
第二批次品牌名称修改
将：
1. "一点外卖"改为"一点外卖"（去掉AI前缀）
2. "未来日程"改为"未来日程"（去掉AI前缀）
3. "一点外卖"改为"一点外卖"
4. "未来规划"改为"未来规划"
"""
...
REPLACEMENTS = {
    ...
    "未来规划": "未来规划",
    # 可能还有其他变体
    "未来规划": "未来规划",  # 如果用户说的是"未来规划"而不是"未来日程"
}
...
def main():
    ...
    # 保存修改记录
    if changed_files:
        with open(project_root / "brand_rename_v2.log", 'w', encoding='utf-8') as f:
            f.write("第二批次品牌名称修改记录\n")
            f.write("=" * 50 + "\n")
